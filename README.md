...
starting to use sub-team to split it. 
    ...
    * also bring in a new agent: audit agent which can spins up all three workers simultaneously to fetch data instantly, 
    rather than waiting for one after another and it will compile a summary report of it
